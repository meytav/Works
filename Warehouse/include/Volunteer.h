...
class Volunteer {
    ...
    //      virtual bool hasOrdersLeft() const;  // No '= 0'
    // virtual bool canTakeOrder(const Order &order) const;  // No '= 0'
    // virtual void acceptOrder(const Order &order);  // No '= 0'
    // virtual void step();  // No '= 0'
